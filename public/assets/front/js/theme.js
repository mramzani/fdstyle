...
/*====== StickyHeader ======*/
RINO.StickyHeader = function () {
    var pageHeaderheight = $(".page-header").height();
    var navWrapperheight = $(".page-header .nav-wrapper").height();
    if ($(".page-header").length) {
        $(".page-content").css(
            "margin-top",
            pageHeaderheight + navWrapperheight - 24
        );
    }
    ...
    window.addEventListener("scroll", function () {
        ...
        if (
            ...
            !$(".nav-wrapper").hasClass("is-active")
        ) {
...
RINO.CategoryList = function () {
    ...
    $(".ri-mega-menu-li").on("mouseenter", function () {
        $(this).addClass("is-active");
        $(".page-header-overlay").fadeIn(200);
    });
    $(".ri-mega-menu-li").on("mouseleave", function () {
        $(this).removeClass("is-active");
        $(".page-header-overlay").fadeOut(200);
    });
...
/*====== ResponsiveHeader ======*/
RINO.ResponsiveHeader = function () {
    $(".header-responsive .btn-toggle-side-navigation").on(
        "click",
        function (event) {
    ...
    $(".header-responsive .side-navigation ul li.has-children > a").on(
        "click",
        function (event) {
    ...
    $(".header-responsive .overlay-side-navigation").on(
        "click",
        function (event) {
...
/*====== SweetAlert ======*/
RINO.SweetAlert = function () {
    $(".user-item.cart-list > ul li.cart-items ul .cart-item .remove-item").on(
        "click",
        function () {
            Swal.fire({
    ...
    $(".product-card .product-card-bottom .btn-add-to-cart").on(
        "click",
        function (event) {
            event.preventDefault();
    ...
    $(".product-card .product-card-actions .add-to-wishlist").on(
        "click",
        function (event) {
            event.preventDefault();
            const Toast = Swal.mixin({
    ...
    $(".product-card .product-card-actions .add-to-compare").on(
        "click",
        function (event) {
            event.preventDefault();
            const Toast = Swal.mixin({
...
/*====== Tooltip ======*/
RINO.Tooltip = function () {
    $('[data-toggle="tooltip"]').tooltip();
};
/* end Tooltip ======*/

/*====== productAddTo ======*/
RINO.ProductAddTo = function () {
...
/*====== CollapseWidget ======*/
RINO.CollapseWidget = function () {
    $(".btn-collapse").on("click", function () {
        var btnCollapse = $(this);
        btnCollapse.toggleClass("btn-collapsed");
        btnCollapse
            .parent(".sidebar-widget-title")
            .siblings(".collpase-widget")
            .slideToggle();
    });
};
/*====== end CollapseWidget ======*/
...
RINO.SwiperSlider = function () {
    ...
    if ($(".quick-view-gallery-slider").length) {
        ...
        var quickViewGallerySliderThumbs = new Swiper(
            ".quick-view-gallery-slider-thumbs",
            {
                slidesPerView: 4,
                touchRatio: 0.2,
                slideToClickedSlide: true,
...
RINO.FilterOptionsSidebar = function () {
...
RINO.ResponsiveTabOrderList = function () {
