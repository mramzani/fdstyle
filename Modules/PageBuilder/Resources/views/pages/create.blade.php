...
@section('dashboardTitle','ایجاد صفحه جدید')
@section('styles')
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') border-danger @enderror"
                                       value="{{ old('title','') }}" id="title" name="title" placeholder="عنوان صفحه">
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('slug') border-danger @enderror"
                                       value="{{ old('slug','') }}" id="slug" name="slug" placeholder="اسلاگ صفحه">
                                @error('slug')
                                <x-dashboard::validation-error message="{{ $message }}"></x-dashboard::validation-error>
                                @enderror
                            </div>
