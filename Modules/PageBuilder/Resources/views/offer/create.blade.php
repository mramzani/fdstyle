...
@section('dashboardTitle','ایجاد آفر جدید')
@section('styles')
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form action="{{ route('dashboard.offer.store') }}" method="post">
            @csrf
            <div class="row">
                ...
                <div class="col-xl-9 col-md-8 col-12 mb-md-0 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label input-required" for="products">لیست محصولات</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('percent') border-danger @enderror"
                                       value="{{ old('percent','') }}" id="percent" name="percent">
                                @error('percent')
                                @include('dashboard::partials.validation-error')
                                @enderror
                            </div>
