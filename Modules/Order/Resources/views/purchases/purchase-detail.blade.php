<div class="offcanvas-header">
    <div>
        <h5 id="offcanvasEndLabel" class="offcanvas-title">
            اطلاعات فاکتور: {{ $purchase->invoice_number }}
            @php
                $percent = round(($purchase->paid_amount * 100) / $purchase->total);
            @endphp
        </h5>
    ...
    <div class="d-flex justify-content-between">
            ...
            @if($purchase->total > $purchase->paid_amount)
    ...
    <div class="table-responsive text-nowrap">
        <table class="table table-borderless">
            ...
            <tr>
                ...
                <td>{{ $purchase->staff->full_name }}</td>
            </tr>
            ...
            <tr>
                <td>{{ number_format($purchase->total) }} تومان</td>
                <td>{{ number_format($purchase->paid_amount) }} تومان</td>
                <td>{{ number_format($purchase->due_amount) }} تومان</td>
            </tr>
            ...
            <tr>
                <td>{{ number_format($purchase->discount) }} تومان</td>
                <td>{{ number_format($purchase->shipping) }} تومان</td>
                <td>0</td>
            </tr>
                ...
                @else
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            ...
                            @foreach($purchase->payments()->where('payment_type','out')->get() as $payment)
                                <tr>
