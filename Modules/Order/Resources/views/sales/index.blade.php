...
@section('dashboardTitle','لیست فروش')
@section('styles')
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-xl-12">
                <h6 class="text-muted">لیست فروش</h6>
                @include('dashboard::partials.alert')
                <livewire:order::sales.sales-list/>
            </div>
        </div>
    ...
    <script>
        ...
        @can('sales_show_detail')
            ...
            if (!isNaN(saleId)) {
                $.ajax({
                    type: "POST",
                    url: '{{ route('dashboard.sales.get-detail') }}',
                    data: {
                        sale_id: saleId
                    },
                    headers: {
