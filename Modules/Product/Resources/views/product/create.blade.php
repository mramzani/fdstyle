                ...
                <div class="col-md-9 col-xl-9 col-sm-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body my-1 p-3">
                            ...
                            <div class="my-3">
                                <input type="text" id="slug" name="slug" class="form-control text-start"
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="dropzone dropzone-area mt-2" id="imgDropzone">
                                <div class="dz-message">@lang('product::products.Click here to upload the image')</div>
                            </div>
                    ...
                    <div class="card mb-4 d-none">
                        ...
                        <div class="card-body mt-2">
                            <div class="form-check form-check-inline ">
                                <input name="status" class="form-check-input" type="radio" checked value="enable"
                                       id="enable">
